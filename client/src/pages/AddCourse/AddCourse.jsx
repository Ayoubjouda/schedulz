...
const validateSchema = z.object({
  ...
  thumbnail: z
    .any()
    .refine((files) => files?.[0]?.size <= MAX_FILE_SIZE, `Max file size is 3MB.`) // this should be greater than or equals (>=) not less that or equals (<=)
    .refine(
...
const AddCourse = () => {
  ...
  return (
    <div className="flex-col w-full h-full bg-gray-50">
